  ...
  return (
    <div className="mx-auto max-w-2xl px-4">
      ...
      <section className="pb-8 pt-12 sm:pt-20">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border-2 border-stone-300 px-6 py-3 text-sm font-bold text-stone-700 transition-all hover:border-stone-400 active:scale-[0.97] dark:border-stone-700 dark:text-stone-300 dark:hover:border-stone-600"
          >
            Search brands
          </button>
          <Link
      ...
      <section className="border-t border-stone-200 py-10 dark:border-stone-800">
        ...
        <h3 className="mt-3 text-2xl font-black tracking-tight text-stone-900 sm:text-3xl dark:text-stone-50">
          Every purchase is a vote.
        </h3>
        <p className="mt-3 max-w-lg text-sm leading-relaxed text-stone-600 dark:text-stone-400">
        ...
        {["Confectionery", "Coffee", "Household", "Personal Care", "Tea", "Beverages", "Baby Care", "Oral Care", "Dairy Alternatives"].map((cat) => {
          ...
          return (
            <div key={cat} className="mt-6">
              <h4 className="mb-2 text-xs font-bold uppercase tracking-wider text-stone-400 dark:text-stone-500">
                {cat}
              </h4>
      ...
      <section className="border-t border-stone-200 py-10 dark:border-stone-800">
        ...
        <p className="mt-3 max-w-lg text-sm text-stone-600 dark:text-stone-400">
          ...
          They manage over <strong className="text-stone-900 dark:text-stone-200">$20 trillion</strong> in assets.
          The same money. The same people. Everywhere you look.
        </p>

        <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-xl border border-stone-200 bg-white p-4 text-center dark:border-stone-800 dark:bg-stone-900">
          ...
          <div className="rounded-xl border border-stone-200 bg-white p-4 text-center dark:border-stone-800 dark:bg-stone-900">
            <p className="text-2xl font-black text-stone-900 dark:text-stone-100">$1T+</p>
        ...
        <div className="mt-6 flex flex-col gap-2">
          {corporations.slice(0, 6).map((corp) => {
            ...
            return (
              <Link
                ...
                className="group flex items-center justify-between rounded-lg border border-stone-200 bg-white px-4 py-3 transition-all hover:border-red-300 dark:border-stone-800 dark:bg-stone-900 dark:hover:border-red-800"
              >
                <div>
                  <span className="text-sm font-bold text-stone-900 dark:text-stone-100">{corp.name}</span>
                  <span className="ml-2 text-xs text-stone-400">{corp.revenue}</span>
                </div>
                <div className="text-right text-xs text-stone-500 dark:text-stone-500">
                  {topOwner ? (
          ...
          <button
            onClick={() => setShowExplore(true)}
            className="mt-1 text-center text-xs font-semibold text-red-600 hover:underline dark:text-red-400"
          >
      ...
      {/* ═══ MANIFESTO FOOTER ═══ */}
      <section className="border-t border-stone-200 py-10 dark:border-stone-800">
        <blockquote className="text-lg font-bold italic leading-relaxed text-stone-700 dark:text-stone-300">
      ...
      <footer className="border-t border-stone-200 py-6 text-center dark:border-stone-800">
...
function ExplorePage({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 pb-24">
      <div className="py-4">
        <button onClick={onBack} className="inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider text-stone-500 hover:text-red-600 dark:text-stone-400">
      ...
      <div className="relative mt-4">
        ...
        <input
          ...
          className="search-input w-full rounded-lg border border-stone-300 bg-white py-2.5 pl-10 pr-4 text-sm text-stone-900 placeholder:text-stone-400 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-100"
        />
      </div>

      {/* Tabs */}
      <div className="mt-4 flex gap-4 border-b border-stone-200 dark:border-stone-800">
